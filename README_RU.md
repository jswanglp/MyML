...
- ##### Линейная регрессия (Linear regression)
    ...
    + ##### Метод спуска с учителем (Supervised Descent Method, SDM) ([code]()) ([notebook-in-colab]()) Хотя это не относится к линейной модели, но оптимальные параметры в этом примере найдены методом регуляризации Тихонова.
