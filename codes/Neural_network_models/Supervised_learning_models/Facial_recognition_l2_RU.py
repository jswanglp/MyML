...
# В программе используется L2 регуляризация для решения проблемы переобучения
# coding: utf-8
...
if __name__ == '__main__':
    ...
    # ---------------------loss-----------------------------
        with tf.name_scope('Loss'):
            ...
            # cross_entropy = tf.reduce_mean(-y * tf.log(y_conv + 1e-10) + reg_tem) # предотвратить log0
        # or like
