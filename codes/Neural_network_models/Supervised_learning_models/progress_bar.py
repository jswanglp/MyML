...
def print_progress(progress, epoch_num, loss, acc):
    ...
    list = [str(epoch_num), "#"*indicator , ">"*(barLength-indicator), progress*100, loss, acc]
    text = "\rEpoch {0[0]} {0[1]} {0[2]} {0[3]:.2f}% completed, loss={0[4]:.4f}, acc={0[5]:.2f}%.{1}".format(list, status)
