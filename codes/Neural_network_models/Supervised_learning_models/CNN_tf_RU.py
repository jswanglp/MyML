...
if __name__ == '__main__':
    ...
    tf.app.flags.DEFINE_integer('batch_size', 196, 'batchsize, default is 196.')
    ...
    # Обучение сетей и сохранение моделей
    ...
    # ----------------------Представление feature map первого сверточного слоя (14*14*32)------------
    ...
    try:
        ...
        pass
    # ----------------------Представление feature map второго сверточного слоя (7*7*32)------------
